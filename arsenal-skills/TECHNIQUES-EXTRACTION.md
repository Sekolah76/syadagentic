# TECHNIQUES-EXTRACTION.md — Teknik Non-Crypto Terbaik dari SYADAGENTIC (kurasi subagent)
...
# automation/bot. Detail lengkap: SYADAGENTIC_frameworks_extraction.md (51KB).
...
## CATATAN
- Teknik di atas = SALINAN/ekstrak — implementasi penuh ada di file SYADAGENTIC asli
  (Downloads/SYADAGENTIC/SYADAGENTIC/) yang READ-ONLY
- Crypto/web3 (sybil audit, on-chain monitor, MEV, governor) = DIHAPUS sesuai user
- Semua teknik = reusable + verified oleh SYADAGENTIC production (bukan klaim)