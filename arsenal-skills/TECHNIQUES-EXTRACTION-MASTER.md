# TECHNIQUES-EXTRACTION-MASTER — TOP Teknik dari tools/ SYADAGENTIC (kurasi subagent)
...
- apply_guardrail_patches.py: PATCH 5 file SOURCE hermes (threat_patterns + 
  ...
  idempotent. (KITA SUDAH punya versi serupa - syadagentic-killer/apply_patches.py)
...
- STATUS: SEMUA file SYADAGENTIC yang subagent refuse = SUDAH ku baca manual.
  Tidak ada yang tersisa (kecuali SKILLS.lock binary + dataset 4622 + vendor lib)


## HERMES-GUARDRAIL-BYPASS (dari SYADAGENTIC — baru ku ambil)
...
- File disalin: arsenal-skills/hermes-bypass/

## INSIGHT BARU (dari AGENTS.md SYADAGENTIC — auto-project-context)
...
DISALIN: arsenal-skills/skills-lengkap/ctf/


## COMPACT JB TEMPLATES PER MODEL (core/templates/compact-templates.yaml + eni-lime)
- 6 payload siap-tempel per model family (disalin ke arsenal-skills/templates-ken/):
