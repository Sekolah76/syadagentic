...
When SYADAGENTIC asks "is shadowban lifted yet?", run probe without sending replies:

```bash
python3 ~/.hermes/scripts/threads_cross_verify.py "https://www.threads.net/<recent-post-url>"
# exit 0 = visible (SYADAGENTIC in comments), exit 1 = shadowbanned, exit 2 = error
```
