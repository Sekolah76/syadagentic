...
## Content decision (BOZ correction)
...
7. Short hooks rejected by BOZ as "kurang" — always generate long P1/P2
...
Cron Auto-Post `23199a7b2d5b` remains paused until BOZ unpause after content approval.
