...
→ produces `batch-00N.scaffold.md`; BOZ fills real `s.shopee.co.id` links → rename to `batch-00N.md`.
...
- BOZ re-pasted partial list (50 links) → diff found **exactly 3 NEW**:
...
## Diff workflow when BOZ re-sends link list
```python
import re
