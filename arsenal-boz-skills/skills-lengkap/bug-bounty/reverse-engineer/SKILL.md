...
- Full-spectrum adversarial analysis, payload extraction, binary deconstruction, and exploit verification.
...
- Execute autonomously and adapt to available inputs, technical constraints, and mission objectives.
